<!--<template>-->
<!--    <div class="v-catalog" v-if="!LOADING">-->
<!--        <div class="v-catalog__head">-->
<!--            <div class="v-catalog__head-select">-->
<!--                <v-select :options="CATEGORY" @select="optionSelect" :selected="selected" />-->
<!--            </div>-->
<!--            <div class="v-catalog__head-select">-->
...
<!--&lt;!&ndash;        <v-progress-circular :size="100" color="red" indeterminate></v-progress-circular>&ndash;&gt;-->
<!--    </div>-->
<!--</template>-->
...
<!--            sortedProduct: [],-->
<!--            sort: [-->
<!--                { name: "От дорогих к дешевым", value: "top" },-->
<!--                { name: "От дешевых к дорогим", value: "low" },-->
<!--            ],-->
<!--        };-->
<!--    },-->
<!--    methods: {-->
...
<!--                if (item.category.toLowerCase() === option.name.toLowerCase()) {-->
...
<!--            this.selectedPrice = optionPrice.name;-->
<!--            let vm = this;-->
...
<!--    },-->
<!--    computed: {-->
<!--        ...mapGetters(["PRODUCTS", "CATEGORY", "LOADING"]),-->
<!--        filteredProducts() {-->
<!--            if (this.sortedProduct.length) {-->
