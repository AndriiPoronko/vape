    ...
    <div class="v-modal-about" v-if="MODALPRODUCT">
      <div class="v-modal-about__block">
        ...
        <div class="v-modal-about__block-right">
          ...
          <div
            class="v-modal-about__block-right-specif"
            v-for="(item, index) in ONEPRODUCT.specifications"
            :key="'item' + index"
          >
            <span>{{item.name}}</span>
            <div class="dotted"></div>
          ...
          <div class="v-modal-about__block-right-specif">
            <span>Комплект:</span>
            <div class="dotted"></div>
            <ul class="equipment">
              <li
                class="equipment-item"
                v-for="(eq, index) of ONEPRODUCT.equipment"
                :key="index"
              >{{ eq }}</li>
            </ul>
          </div>
          ...
          <div
            class="v-modal-about__block-right-block"
            v-for="(about, j) of ONEPRODUCT.about"
            :key="j"
          >
            <div class="v-modal-about__block-right-block-caption">{{about.caption}}</div>
            <div class="v-modal-about__block-right-block-description">{{about.description}}</div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...mapGetters(["MODALPRODUCT", "ONEPRODUCT"]),
  },
};
</script>
